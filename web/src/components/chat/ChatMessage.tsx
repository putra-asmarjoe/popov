...
import { contextPillOf } from "@/lib/chat-meta"
 ...
 *  CHAT3 §4A.2: slot ContextPill di ATAS bubble assistant (meta.context_pill, §4A.5). */
export function ChatMessage({ message }: { message: ChatMessageType }) {
  ...
  const pill = isUser ? null : contextPillOf(message.meta)
