...
from api.public_alerts import router as public_alerts_router  # public alert ingest (ticket trigger)
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # 1C Source Registry (Fix #207)
        from services.source_registry_store import ensure_source_registry_indexes
        await ensure_source_registry_indexes()
    except Exception as e:
...
app.include_router(public_alerts_router, prefix="/api/pub/v1")  # public alert ingest (ticket trigger)
